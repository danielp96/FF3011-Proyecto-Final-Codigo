...
function rect_2_2()
    ...
    graph_n('rect_2.2/figure_n_2',   2);
    graph_n('rect_2.2/figure_n_5',   5);
    graph_n('rect_2.2/figure_n_10',   10);
    graph_n('rect_2.2/figure_n_20',   20);

endfunction

function v = volt(x,y,a,b,n, const)

    v=const*exp(n*pi*(x-a)/b)*sin(n*pi*y/b);
